...
Download the pre-built exe file and run it - [ecs-quiz.exe](https://github.com/lectrical/ecs-health-safety-and-environmental-assessment/raw/refs/heads/main/ecs-quiz.exe)
